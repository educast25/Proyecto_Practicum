...
<div class="container">
    ...
    <form action="{{ route('doctors.update', $doctor->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="contact" name="contact" value="{{ $doctor->correo }}" required>
        </div>
        <div class="form-group">
            <label for="contact">Sexo</label>
            <input type="text" class="form-control" id="contact" name="contact" value="{{ $doctor->sexo }}" required>
        </div>
